...
| [initiative-scout.md](initiative-scout.md) | Vineyard structural-anomaly scouting: georef fusion + field map (`meshsa.scout`) — mission **export** gated on a CHARTER §3 carve-out | **Definition** (peer-reviewed; see [../PLAN_PEER_REVIEW_SCOUT.md](../PLAN_PEER_REVIEW_SCOUT.md)) |
